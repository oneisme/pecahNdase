...
# Banner
print'''  %s____  _____ _________ ____ __           
  \   \/_____//   _____//  |________|__|  | __ ____  ____________
                      .~      ,   . ~.
                     /                \
                    /      /~\/~\   ,  \
                   |   .   \    /   '   |
...
input() #This is the true start of the program           print '%s Quotes are being filtered, its not possible to break out of the context.' % bad
